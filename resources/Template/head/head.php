...
<head>
    ...
    <title>JOB PROTAL | Create Profile</title>

    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&amp;display=fallback">

    <link rel="stylesheet" href="resources/Template/assets/plugins/fontawesome-free/css/all.min.css">
    

    <link rel="stylesheet" href="resources/Template/assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css">

    <link rel="stylesheet" href="resources/Template/assets/dist/css/adminlte.min2167.css?v=3.2.0">

    <script nonce="5da3d12d-3ff9-4efc-a59c-97aefa031487">
